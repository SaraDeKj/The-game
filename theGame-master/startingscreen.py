...
class StartingscreenClass:
    ...
    def background(self, gameWindowWidth, gameWindowHeight):
        while self.done == True:
            ...
            TextRect.center = ((gameWindowWidth / 2)-300, (gameWindowHeight / 4.2))
            self.display.blit(TextSurf, TextRect)
            ...
            TextRect.center = (gameWindowWidth / 2)-300, (gameWindowHeight / 2)
            self.display.blit(TextSurf, TextRect)
            ...
            TextRect.center = ((gameWindowWidth / 2)-300, (gameWindowHeight / 2.01))
            self.display.blit(TextSurf, TextRect)
